                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">لوحة تحكم الطالب</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">الاختبارات المتوفرة</span>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">الاختبارات التي تم تجاوزها</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-like"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">الاتنبيهات</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-list"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">الاختبارات التي رسبت بها</span>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">الاختبارات المقفلة</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-lock"></i>
                                    </div>
						...
						<div class="col-lg-3 col-md-6">
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">الاختبارات التي خضتها</span>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">التنبيهات</h4>
                                </div>
                                <div class="panel-body">
