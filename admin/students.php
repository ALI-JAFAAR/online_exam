						...
						<div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">الطلبة</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">اطافة طالب</a></li>										
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a href="pages/make_sd_in.php?id='.$row['user_id'].'">تعطيل</a>';
											   }else{
											   $st = '<p class="text-danger">معطل</p>'; 
                                               $stl = '<a href="pages/make_sd_ac.php?id='.$row['user_id'].'">تفعيل</a>';											   
											   }
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
													<li><a href="edit-student.php?sid='.$row['user_id'].'">تعديل البيانات</a></li>
													<li><a href="view-student.php?sid='.$row['user_id'].'">عرض</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['first_name']; ?> ?')" <?php print ' href="pages/drop_sd.php?id='.$row['user_id'].'">حذف</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/add_student.php" method="POST" style="direction: rtl;">
										<div class="form-group">
                                            <label for="exampleInputEmail1">الاسم الاول</label>
                                            <input type="text" class="form-control" placeholder="الاسم الاول" name="fname" required autocomplete="off">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">الاسم الاخير</label>
                                            <input type="text" class="form-control" placeholder="الاسم الاخير" name="lname" required autocomplete="off">
                                        </div>
										<div class="form-group">
										  <label for="exampleInputEmail1">ذكر</label>
                                            <input type="radio"  name="gender" value="ذكر" required>
                                            <label for="exampleInputEmail1">انثى</label>
                                            <input type="radio" name="gender" value="انثى" required>
                                        </div>
										<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="رقم الهاتف" name="phone" required autocomplete="off">
                                        </div>
										<div class="form-group">
                                    ...
                                    <input type="text" class="form-control date-picker" name="dob" required autocomplete="off" placeholder="تاريخ الميلاد">
                                    </div>
									
									<div class="form-group">
                                            <label for="exampleInputEmail1">العنوان</label>
                                            <textarea style="resize: none;" rows="4" class="form-control" placeholder="العنوان" name="address" required autocomplete="off"></textarea>
                                     </div>
