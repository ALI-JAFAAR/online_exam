        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>ادارة الاشعارات والتنبيهات</h3>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">الاشعار او التنبيه</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">اظافة اشعار او تنبيه</a></li>
                                            </ul>
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
												    <li><a href="edit-notice.php?id='.$row['notice_id'].'">تعديل</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['title']; ?> ?')" <?php print ' href="pages/drop_not.php?id='.$row['notice_id'].'">حذف</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/add_notice.php" method="POST" style="direction: rtl;">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">العنوان</label>
                                            <input type="text" class="form-control" placeholder="العنوان" name="title" required autocomplete="off">
                                        </div>
										
										<div class="form-group">
                                            <label for="exampleInputEmail1">الوصف</label>
                                            <textarea style="resize: none;" rows="4"  class="form-control" placeholder="الوصف" name="description" required autocomplete="off"></textarea>
                                        </div>
