                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">الفرع</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">اظافة فرع </a></li>
                                            </ul>
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a href="pages/make_dp_in.php?id='.$row['department_id'].'"> تعطيل</a>';
											   }else{
											   $st = '<p class="text-danger">معطل</p>'; 
                                               $stl = '<a href="pages/make_dp_ac.php?id='.$row['department_id'].'">تفعيل</a>';											   
											   }
                                          print '
										       <tr>
                                                <td>'.$row['name'].'</td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['name']; ?> ?')" <?php print ' href="pages/drop_dep.php?id='.$row['department_id'].'">حذف</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/add_department.php" method="POST" style="direction: rtl;">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">اسم الفرع</label>
                                            <input type="text" class="form-control" placeholder="ادخل اسم الفرع" name="department" required autocomplete="off">
                                        </div>
