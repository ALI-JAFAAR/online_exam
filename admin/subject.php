						...
						<div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">المواد</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">اظافة مادة جديدة</a></li>										
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a href="pages/make_sb_in.php?id='.$row['subject_id'].'">تعطيل</a>';
											   }else{
											   $st = '<p class="text-danger">معطل</p>'; 
                                               $stl = '<a href="pages/make_sb_ac.php?id='.$row['subject_id'].'">تفعيل</a>';											   
											   }
                                          print '
										       <tr>
                                                <td>'.$row['name'].'</td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['name']; ?> ?')" <?php print ' href="pages/drop_sb.php?id='.$row['subject_id'].'">حذف</a></li>
                                                </ul>
                                            </div></td>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab6">
                                    <form action="pages/add_subject.php" method="POST" style="direction: rtl;">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="ادخل اسم المادة" name="subject" required autocomplete="off">
                                        </div>
