                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">الامتحانات</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">اظافة امتحان</a></li>										
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   $status = $row['status'];
											   if ($status == "Active") {
											   $st = '<p class="text-success">مغعل</p>';
											   $stl = '<a href="pages/make_ex_in.php?id='.$row['exam_id'].'">تعطيل</a>';
											   }else{
											   $st = '<p class="text-danger">معطل</p>'; 
                                               $stl = '<a href="pages/make_ex_ac.php?id='.$row['exam_id'].'">تفعيل</a>';											   
											   }
                                          print '
										       <tr>
                                                <td>'.$row['exam_name'].'</td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
													<li><a href="edit-exam.php?eid='.$row['exam_id'].'">تعديل الامتحان</a></li>
													<li><a href="view-questions.php?eid='.$row['exam_id'].'">عرض الاسئلة</a></li>
													<li><a href="add-questions.php?eid='.$row['exam_id'].'">اظافة اسئلة</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['exam_name']; ?> ?')" <?php print ' href="pages/drop_ex.php?id='.$row['exam_id'].'">حذف</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/add_exam.php" method="POST" style="direction: rtl;">
										<div class="form-group">
                                            <label for="exampleInputEmail1">اسم الامتحان</label>
                                            <input type="text" class="form-control" placeholder="اسم الامتحان" name="exam" required autocomplete="off">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">مدة الامتحان بالدقائق</label>
                                            <input type="number" class="form-control" placeholder="مدة الامتحان بالدقائق" name="duration" required autocomplete="off">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">درجة النجاح %</label>
                                            <input type="number" class="form-control" placeholder="درجة النجاح %" name="passmark" required autocomplete="off">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">الفتره الزمنية لتجديد الامتحان</label>
                                            <input type="number" class="form-control" placeholder="الفتره الزمنية لتجديد الامتحان" name="attempts" required autocomplete="off">
                                        </div>
									<div class="form-group">
                                    ...
                                    <input type="text" class="form-control date-picker" name="date" required autocomplete="off" placeholder="Select deadline">
										...
										<div class="form-group">
                                            <label for="exampleInputEmail1">اختر المادة</label>
										...
										<div class="form-group">
                                            <label for="exampleInputEmail1">اختر المرحلة</label>
									...
									<div class="form-group">
                                            <label for="exampleInputEmail1">الشروط والتوصيات</label>
                                            <textarea style="resize: none;" rows="6" class="form-control" placeholder="الشروط والتوصيات" name="instructions" required autocomplete="off"></textarea>
                                     </div>
