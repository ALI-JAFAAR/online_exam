...
<head>
    ...
    <body <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>  class="page-header-fixed">
        ...
        <div class="menu-wrap">
            ...
            <button class="close-button" id="close-button">الخروج</button>
        </div>
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													...
													<li><a href="view-results.php?eid='.$row['exam_id'].'">رؤية النتيجة</a></li>
									                <li><a href="summary.php?eid='.$row['exam_id'].'">وصف مختصر</a></li>
