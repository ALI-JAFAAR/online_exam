                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">الاختيار المتعدد</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">املاء الفراغات</a></li>
                                            </ul>
                                    
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active fade in" id="tab5">
                                                <form action="pages/add_question2.php?type=mc" method="POST" style="direction: rtl;">
											<div class="form-group">
                                            <label for="exampleInputEmail1">اسم الاختبار</label>
										    <select class="form-control" name="exam" required>
											<option value="" selected disabled>-اسم الاختبار-</option>
										 	<?php
                                      ...
                                      <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th width="100">رقم الاختيار</th>
                                                <th>الاختيار</th>
                                                <th  width="100" >الجواب</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
												<div class="form-group">
                                                <label for="exampleInputEmail1">الخيار رقم 1</label>
                                                <input type="text" class="form-control" placeholder="الخيار رقم 1" name="opt1" required autocomplete="off">
                                                </div>
												</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
												<div class="form-group">
                                                <label for="exampleInputEmail1">الخيار رقم 2</label>
                                                <input type="text" class="form-control" placeholder="الخيار رقم 2" name="opt2" required autocomplete="off">
                                                </div>
												</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
												<div class="form-group">
                                                <label for="exampleInputEmail1">الخيار رقم 3</label>
                                                <input type="text" class="form-control" placeholder="الخيار رقم 3" name="opt3" required autocomplete="off">
                                                </div>
												</td>
											...
											<tr>
                                                ...
                                                <td>
												<div class="form-group">
                                                <label for="exampleInputEmail1">الخيار رقم 4</label>
                                                <input type="text" class="form-control" placeholder="الخيار رقم 4" name="opt4" required autocomplete="off">
                                                </div>
												</td>
									 ...
									 <button type="submit" class="btn btn-primary">حفظ</button>
                                         ...
                                         <form action="pages/add_question2.php?type=fib" method="POST" style="direction: rtl;">
										 	<div class="form-group">
                                            <label for="exampleInputEmail1">اسم الاختبار</label>
										    <select class="form-control" name="exam" required>
											<option value="" selected disabled>-اسم الاختبار-</option>
                                            ...
                                            print '<option value="'.$row['exam_id'].'">'.$row['exam_name'].'</option>';
											 ...
											 ?>
												...
												<div class="form-group">
                                                <label for="exampleInputEmail1">السؤال</label>
                                                <input type="text" class="form-control" placeholder="السؤال" name="question" required autocomplete="off">
                                                </div>
												<div class="form-group">
                                                <label for="exampleInputEmail1">الجواب</label>
                                                <input type="text" class="form-control" placeholder="الجواب" name="answer" required autocomplete="off">
                                                </div>
